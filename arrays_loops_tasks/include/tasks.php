        ...
        <div class="panel-heading" role="tab" id="headingOne">
            <h2 class="panel-title">
                <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne"
                   aria-expanded="false" aria-controls="collapseOne">Работа с foreach <span class="caret"></a>
            </h2>
        </div>
        <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
            <div class="list-group">
                <a href="show.php?task=1" class="list-group-item<?= $currentTask == '1' ? ' active' : '' ?>">
                    ...
                    <p class="list-group-item-text">Дан массив с элементами 'html', 'css', 'php', 'js', 'jq'. С помощью
                        цикла
                ...
                <a href="show.php?task=2" class="list-group-item<?= $currentTask == '2' ? ' active' : '' ?>">
                    ...
                    <p class="list-group-item-text">Дан массив с элементами 1, 20, 15, 17, 24, 35. С помощью цикла
                        foreach
                ...
                <a href="show.php?task=3" class="list-group-item<?= $currentTask == '3' ? ' active' : '' ?>">
                    ...
                    <p class="list-group-item-text">Дан массив с элементами 26, 17, 136, 12, 79, 15. С помощью цикла
                        foreach
        ...
        <div class="panel-heading" role="tab" id="headingTwo">
            <h2 class="panel-title">
                <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo"
                   aria-expanded="false" aria-controls="collapseTwo">Работа с ключами <span class="caret"></a>
            </h2>
        </div>
        <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
            <div class="list-group">
                <a href="show.php?task=4" class="list-group-item<?= $currentTask == '4' ? ' active' : '' ?>">
                    ...
                    <p class="list-group-item-text">Дан массив $arr. С помощью первого цикла foreach выведите на экран
                        столбец
                ...
                <a href="show.php?task=5" class="list-group-item<?= $currentTask == '5' ? ' active' : '' ?>">
                    ...
                    <p class="list-group-item-text">Дан массив $arr с ключами 'Коля', 'Вася', 'Петя' с элементами '200',
                        '300',
                        '400'. С помощью цикла foreach выведите на экран столбец строк такого формата: 'Коля — зарплата
                        200
                        долларов.'.</p>
                </a>
                <a href="show.php?task=6" class="list-group-item<?= $currentTask == '6' ? ' active' : '' ?>">
                    ...
                    <p class="list-group-item-text">Дан массив $arr. С помощью цикла foreach запишите английские
                        названия в
                ...
                <a href="show.php?task=7" class="list-group-item<?= $currentTask == '7' ? ' active' : '' ?>">
                    ...
                    <p class="list-group-item-text">Дан массив с элементами 2, 5, 9, 15, 0, 4. С помощью цикла foreach и
                        оператора if выведите на экран столбец тех элементов массива, которые больше 3­х, но меньше
                        10.</p>
                </a>
                <a href="show.php?task=8" class="list-group-item<?= $currentTask == '8' ? ' active' : '' ?>">
                    ...
                    <p class="list-group-item-text">Дан массив с элементами 1, 2, 3, 4, 5, 6, 7, 8, 9. С помощью цикла
                        foreach
        ...
        <div class="panel-heading" role="tab" id="headingThree">
            <h2 class="panel-title">
                <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree"
                   aria-expanded="false" aria-controls="collapseThree">Циклы while и for <span class="caret"></a>
            </h2>
        </div>
        <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
            <div class="list-group">
                ...
                <a href="show.php?task=12" class="list-group-item<?= $currentTask == '12' ? ' active' : '' ?>">
                    ...
                    <p class="list-group-item-text">Дано число $n = 1000. Делите его на 2 столько раз, пока результат
                        деления не
                ...
                <a href="show.php?task=14" class="list-group-item<?= $currentTask == '14' ? ' active' : '' ?>">
                    ...
                    <p class="list-group-item-text">Дан массив с элементами 4, 2, 5, 19, 13, 0, 10. С помощью цикла
                        foreach
                        и
                ...
                <a href="show.php?task=15" class="list-group-item<?= $currentTask == '15' ? ' active' : '' ?>">
                    ...
                    <p class="list-group-item-text">Дан массив $arr. С помощью цикла foreach и переменной $count
                        подсчитайте
                        количество элементов этого массива. Проверьте работу скрипта на примере массива с элементами 4,
                        2,
                        5,
                        19, 13, 0, 10.</p>
                </a>
                ...
                <a href="show.php?task=17" class="list-group-item<?= $currentTask == '17' ? ' active' : '' ?>">
                    ...
                    <p class="list-group-item-text">Составьте массив месяцев. С помощью цикла foreach выведите все
                        месяцы, а
                ...
                <a href="show.php?task=18" class="list-group-item<?= $currentTask == '18' ? ' active' : '' ?>">
                    ...
                    <p class="list-group-item-text">Составьте массив дней недели. С помощью цикла foreach выведите все
                        дни
                ...
                <a href="show.php?task=20" class="list-group-item<?= $currentTask == '20' ? ' active' : '' ?>">
                    ...
                    <p class="list-group-item-text">Нарисуйте пирамиду, как показано на рисунке, только у вашей пирамиды
                        должно
                ...
                <a href="show.php?task=22" class="list-group-item<?= $currentTask == '22' ? ' active' : '' ?>">
                    ...
                    <p class="list-group-item-text">Нарисуйте пирамиду, как показано на рисунке, воспользовавшись циклом
                        for
                        или
                        while.<br><br>
                        xx<br>
                ...
                <a href="show.php?task=23" class="list-group-item<?= $currentTask == '23' ? ' active' : '' ?>">
                    ...
                    <p class="list-group-item-text">Вам нужно разработать программу, которая считала бы сумму цифр числа
                        введенного пользователем. Например: есть число 123, то программа должна вычислить сумму цифр 1,
                        2,
                        3, т.
                        е. 6.<br>
                ...
                <a href="show.php?task=24" class="list-group-item<?= $currentTask == '24' ? ' active' : '' ?>">
                    ...
                    <p class="list-group-item-text">Вам нужно разработать программу, которая считала бы количество
                        вхождений
                ...
                <a href="show.php?task=25" class="list-group-item<?= $currentTask == '25' ? ' active' : '' ?>">
                    ...
                    <p class="list-group-item-text">Ваше задание создать массив, наполнить это случайными значениями
                        (функция
                ...
                <a href="show.php?task=26" class="list-group-item<?= $currentTask == '26' ? ' active' : '' ?>">
                    ...
                    <p class="list-group-item-text">Вам нужно создать массив и заполнить его случайными числами от 1 до
                        100
                        (ф­я
                        rand). Далее, вычислить произведение тех элементов, которые больше ноля и у которых парные
                        индексы.
                ...
                <a href="show.php?task=27" class="list-group-item<?= $currentTask == '27' ? ' active' : '' ?>">
                    ...
                    <p class="list-group-item-text">Создать генератор случайных таблиц. Есть переменные: $row - кол-во
                        строк
                        в
                        ...
                        который по заданным условиям выведет таблицу размера $rows на $cols, в которой все ячейки будут
                        иметь цвета, выбранные случайным образом из массива $colors. В каждой ячейке должно находиться
                        случайное число.
